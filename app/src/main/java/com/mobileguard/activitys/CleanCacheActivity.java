...
import com.mobileguard.utils.CleanMessageUtil;
...
public class CleanCacheActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        packinfos = packageManager.getInstalledPackages(PackageManager.GET_PERMISSIONS);
    }
    ...
    /*    try {
            String cacheSize =  CleanMessageUtil.getTotalCacheSize(CleanCacheActivity.this);
            System.out.println("-----------cacheSize--------------"+cacheSize);
            CleanMessageUtil.clearAllCache(CleanCacheActivity.this);
        } catch (Exception e) {
            e.printStackTrace();
        }*/
         scanPackages();
        ...
        new AsyncTask<Void, Integer, Void>() {
            ...
            protected void onPostExecute(Void result) {
                ...
                for (final String packname : cachePagenames) {
                    ...
                    View child = View.inflate(CleanCacheActivity.this,
                            R.layout.layout_cache_item_style, null);
                    // 为child注册一个监听器。
